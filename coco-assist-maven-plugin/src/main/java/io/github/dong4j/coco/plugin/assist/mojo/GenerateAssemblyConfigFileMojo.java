...
import io.github.dong4j.coco.plugin.common.enums.ApplicationType;
import io.github.dong4j.coco.plugin.common.util.FileUtils;
import io.github.dong4j.coco.plugin.common.util.ReflectionUtils;
...
public class GenerateAssemblyConfigFileMojo extends CocoAbstractMojo {

    /** 默认忽略此插件 */
    @Parameter(property = Plugins.SKIP_ASSEMBLY_CONFIG, defaultValue = Plugins.TURN_OFF_PLUGIN)
    private boolean skip;
    /** Output file */
    @Parameter(defaultValue = "${project.build.directory}/coco-plugin/assembly/assembly.xml")
