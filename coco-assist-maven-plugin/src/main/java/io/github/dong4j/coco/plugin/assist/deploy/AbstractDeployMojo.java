package io.github.dong4j.coco.plugin.assist.deploy;
 ...
 * @since 1.0.0
 */
abstract class AbstractDeployMojo extends CocoAbstractMojo {
    ...
    /**
     * Create deployment artifact repository artifact repository
     *
     * @param id  id
     * @param url url
