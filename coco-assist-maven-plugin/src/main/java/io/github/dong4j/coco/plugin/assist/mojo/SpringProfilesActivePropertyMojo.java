...
public class SpringProfilesActivePropertyMojo extends CocoAbstractMojo {
    /** LOCAL */
    ...
    /** Output file */
    @Parameter(defaultValue = "${project.build.directory}/coco-plugin/profile/spring.profiles.active")
