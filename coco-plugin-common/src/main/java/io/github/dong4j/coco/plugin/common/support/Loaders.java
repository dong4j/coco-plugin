package io.github.dong4j.coco.plugin.common.support;
...
public abstract class Loaders {
     ...
     */
    @Contract(" -> new")
    public static @NotNull Loader std() {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader std(ClassLoader classLoader) {
     ...
     *
     * @return 按包名来加载的资源加载器 loader
     * @since 1.0.0
     */
    @Contract(" -> new")
    public static @NotNull Loader pkg() {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader pkg(ClassLoader classLoader) {
     ...
     * <p>1. Loaders.pkg(Loaders.ant()).load("*"); 加载io.loadkit包下的资源, 但不递归加载子包.</p>
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader pkg(Loader delegate) {
     ...
     */
    @Contract(" -> new")
    public static @NotNull Loader ant() {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader ant(ClassLoader classLoader) {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader ant(Loader delegate) {
     ...
     */
    @Contract(" -> new")
    public static @NotNull Loader regex() {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader regex(ClassLoader classLoader) {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader regex(Loader delegate) {
     ...
     *
     * @param root 根目录
     * @return 文件资源加载器 loader
     * @throws IOException I/O 异常
     * @since 1.0.0
     */
    @Contract("_ -> new")
    public static @NotNull Loader file(File root) throws IOException {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader file(URL fileURL) {
     ...
     */
    @Contract("_, _ -> new")
    public static @NotNull Loader file(URL context, File root) {
     ...
     *
     * @param file JAR包文件
     * @return AR包资源加载器 loader
     * @throws IOException I/O 异常
     * @since 1.0.0
     */
    @Contract("_ -> new")
    public static @NotNull Loader jar(File file) throws IOException {
     ...
     */
    @Contract("_ -> new")
    public static @NotNull Loader jar(URL jarURL) throws IOException {
     ...
     * @param jarFile JAR文件
     * @return JAR包资源加载器 loader
     * @since 1.0.0
     */
    @Contract("_, _ -> new")
    public static @NotNull Loader jar(URL context, JarFile jarFile) {
