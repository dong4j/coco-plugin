package io.github.dong4j.coco.plugin.deploy.mojo;
...
import io.github.dong4j.coco.plugin.deploy.mojo.entity.Group;
import io.github.dong4j.coco.plugin.deploy.mojo.entity.Server;
import io.github.dong4j.coco.plugin.deploy.mojo.util.SSHAgent;
import io.github.dong4j.coco.plugin.deploy.mojo.util.TimeoutUtil;
 ...
 */
@Slf4j
abstract class ServicePublishMojo extends CocoAbstractMojo {
    ...
    protected void init() {
        ...
        this.username = System.getProperty("publish.username", "publisher");
        this.password = System.getProperty("publish.password", "publisher");
        ...
        this.publishNamespace = System.getProperty("publish.name.space",
                                                   this.project.getProperties().getProperty("publish.name.space", "coco"));
    ...
    protected void generalStep(SSHAgent sshAgent, String publishFileName, File file, String groupId, String env) {
        ...
        sshAgent.execCommand("3.1 输出当前环境变量", "sudo -E -u coco echo $PATH");
    ...
    protected void betweenStep(@NotNull SSHAgent sshAgent,
        ...
        sshAgent.execCommand("3.6 修改用户组",
                             StrFormatter.format("sudo chown -R coco:coco {}/{}/{}/*",
                                                 this.publishTargetPath,
                                                 env, groupId));
    ...
    protected void runServerShell(@NotNull SSHAgent sshAgent,
        ...
        String cmd = "cd {}/{}/{}/{}; sudo -E -u coco bin/server.sh -r {} -n {} &";
        if (Boolean.TRUE.equals(this.enbaleApm)) {
            cmd = "cd {}/{}/{}/{}; sudo -E -u coco bin/server.sh -r {} -w -n {} &";
        }
