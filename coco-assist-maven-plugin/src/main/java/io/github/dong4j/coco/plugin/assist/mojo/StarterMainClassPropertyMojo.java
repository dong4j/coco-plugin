...
/**
 * <p>Description: 在 validate 阶段将解析到的 main class 注入到 name, 不需要手动设置 maven-jar-plugin mainClass 属性 </p>
 *
 * @author dong4j
 * @version 1.0.3
...
public class StarterMainClassPropertyMojo extends CocoAbstractMojo {
